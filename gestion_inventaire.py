...
def consolidate_files(input_directory str, output_file
...
if consolidated_data
    ...
    def search_inventory(file_path str, filters
    ...
    def generate_summary(file_path str, output_file
    ...
    with open(file_path, 'r', newline='') as file
        ...
        for row in reader
            ...
            if category not in summary
                summary[category] = {'total_quantity'
                0, 'total_value'
                0}

                summary[category]['total_quantity'] += quantity
                summary[category]['total_value'] += quantity
                price
